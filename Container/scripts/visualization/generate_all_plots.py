...
def main() -> int:
    ...
    parser.add_argument("--node-metrics-dir", default="Container/metrics/node_exporter")
    ...
    out_dir = Path(args.out_dir) if args.out_dir else (Path("Container/metrics/plots"))
