...
phase_breakdown.png. For Wasm, archive creation is part of the plotted transfer
phase, while destination unpack remains inside the broad restore timer used by
the benchmark.
"""
