...
def main() -> int:
    ...
    parser.add_argument("--csv", default="WASM-migration/metrics/migration_metrics.csv")
    ...
    parser.add_argument(
        "--node-metrics-dir", default="WASM-migration/metrics/node_exporter"
    )
    ...
    out_dir = (
        Path(args.out_dir) if args.out_dir else (Path("WASM-migration/metrics/plots"))
    )
