...
- `direct` uses VM→VM `scp` and requires SSH trust; the orchestrator sets this up automatically (see `Game-of-life-migration/scripts/orchestrators/ssh_utils.py`).
