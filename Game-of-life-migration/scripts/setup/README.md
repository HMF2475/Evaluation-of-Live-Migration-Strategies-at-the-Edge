...
```bash
bash Game-of-life-migration/scripts/setup/install_node_exporter.sh edge-node-1 edge-node-2 edge-host-1
```

### Bootstrap the Kubernetes cluster

```bash
bash Game-of-life-migration/scripts/setup/bootstrap_k8s_cluster.sh \
...
```bash
bash Game-of-life-migration/scripts/setup/apply_tc_netem.sh \
...
```bash
bash Game-of-life-migration/scripts/setup/snapshot_node_exporter.sh \
  --node edge-node-1 \
  --out Game-of-life-migration/metrics/node_exporter/edge-node-1.prom
```
